...
(
  ...
  pip install https://github.com/pycabbage/RVC-Docker/releases/download/wheel/fairseq-0.12.2-${PYTHON_VERSION_CODE}-${PYTHON_VERSION_CODE}-linux_x86_64.whl
  pip install https://github.com/pycabbage/RVC-Docker/releases/download/wheel/pyworld-0.3.2-${PYTHON_VERSION_CODE}-${PYTHON_VERSION_CODE}-linux_x86_64.whl
